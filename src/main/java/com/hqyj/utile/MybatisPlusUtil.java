...
public class MybatisPlusUtil {
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://47.113.185.8:3306/crm?useUnicode=true&characterEncoding=UTF-8&zeroDateTimeBehavior=convertToNull");
        ...
        strategy.setInclude("customer_feedback");
        //配置驼峰转连字符
